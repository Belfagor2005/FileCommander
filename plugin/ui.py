...
class FileCommanderScreen(Screen, HelpableScreen, key_actions):
    if FULLHD:
        ...
        <screen position="40,80" size="1840,920" title="" flags="wfNoBorder">
            ...
            <widget name="list_left_free" position="30,845" size="200,25" font="Regular;24" /><!-- for FileCommanderScreenFileSelect, do not remove it -->
            <widget name="list_right_free" position="920,845" size="200,25" font="Regular;24" /><!-- for FileCommanderScreenFileSelect, do not remove it -->
            <widget name="sort_left" position="10,845" size="855,26" halign="center" font="Regular;24" foregroundColor="#00cccc40" />
            <widget name="sort_right" position="900,845" size="855,26" halign="center" font="Regular;24" foregroundColor="#00cccc40" />
            <widget source="key_red" render="Label" position="150,880" size="390,38" transparent="1" font="Regular;32" />
            <widget source="key_green" render="Label" position="593,880" size="390,38" transparent="1" font="Regular;32" />
            <widget source="key_yellow" render="Label" position="1035,880" size="390,38" transparent="1" font="Regular;32" />
            <widget source="key_blue" render="Label" position="1488,880" size="390,38" transparent="1" font="Regular;32" />
...
class FileCommanderScreenFileSelect(Screen, HelpableScreen, key_actions):
    ...
    def goParentfolder(self):
        if self.ACTIVELIST == self.SOURCELIST:
            return
        if self.ACTIVELIST.getParentDirectory() is False:
